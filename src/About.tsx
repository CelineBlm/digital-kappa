    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="px-4 py-12 lg:px-20 lg:py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block bg-[rgba(210,163,11,0.1)] px-6 py-2 rounded-full mb-6">
            <span className="text-[#d2a30b] font-['Montserrat',sans-serif] text-sm">À propos de nous</span>
          </div>
          <h1 className="font-['Merriweather',serif] text-[#1a1a1a] mb-6 text-[3rem]">
        ...
        {/* Stats */}
        <div className="max-w-6xl mx-auto mt-12 lg:mt-16 grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
      ...
      <section className="px-4 py-12 lg:px-20 lg:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <h2 className="font-['Merriweather',serif] text-[#1a1a1a] mb-6">Notre histoire</h2>
      ...
      <section className="px-4 py-12 lg:px-20 lg:py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-['Merriweather',serif] text-[#1a1a1a] mb-4">Nos valeurs</h2>
      ...
      <section className="px-4 py-12 lg:px-20 lg:py-20 bg-[#1a1a1a]">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-['Merriweather',serif] text-white text-center mb-12">
            Ce qui nous différencie
          </h2>
      ...
      <section className="px-4 py-12 lg:px-20 lg:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-['Merriweather',serif] text-[#1a1a1a] text-center mb-8">
            À propos de Digital Kappa : Notre mission et nos valeurs
          </h2>
          <div className="prose prose-lg max-w-none text-[#4a5565] space-y-4">
            <p>
