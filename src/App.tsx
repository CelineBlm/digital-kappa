...
export default function App() {
  const [currentPage, setCurrentPage] = useState<'home' | 'how-it-works' | 'all-products' | 'ebooks' | 'applications' | 'templates' | 'faq' | 'product-detail' | 'about' | 'cgv' | 'privacy' | 'checkout'>('all-products');
