    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="font-['Merriweather',serif] text-[#1a1a1a] mb-4 text-[3rem]">Produit non trouvé</h1>
          <button 
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="space-y-6">
              <div>
                ...
                <h1 className="font-['Merriweather',serif] text-[#1a1a1a] mb-4 text-[3rem]">
                  {product.title}
                </h1>
      ...
      <section className="py-12 lg:py-16 px-4 lg:px-20 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="font-['Merriweather',serif] text-[#1a1a1a] mb-4">
            Description complète
          </h2>
      ...
      <section className="py-12 lg:py-16 px-4 lg:px-20 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="font-['Merriweather',serif] text-[#1a1a1a] mb-6">
            Fonctionnalités principales
          </h2>
      ...
      <section className="py-12 lg:py-16 px-4 lg:px-20 bg-[#2b2d31]">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-['Merriweather',serif] text-white text-center mb-8">
