        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <button 
              ...
              className="text-sm text-[#4a5565] hover:text-[#d2a30b] flex items-center gap-2 mb-4"
            >
              <ChevronRight size={16} className="rotate-180" />
              Retour à l&apos;accueil
            </button>
            <h1 className="font-['Merriweather',serif] text-[#1a1a1a] mb-3 text-[3rem]">Tous nos produits</h1>
