...
function Hero({ onNavigateHowItWorks }: { onNavigateHowItWorks: () => void }) {
  return (
    <section className="bg-gray-50 relative overflow-hidden">
      <div className="px-4 lg:px-20 py-8 lg:py-12 relative">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="font-['Merriweather',serif] text-[#0d1421] text-[3rem]">
    ...
    <section className="bg-white py-12 lg:py-20 px-4 lg:px-20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10 lg:mb-12">
          <h2 className="font-['Merriweather',serif] text-[#1a1a1a] mb-4 text-[2rem]">Pourquoi choisir Digital Kappa</h2>
...
function ProductsSection({ onNavigateAllProducts }: { onNavigateAllProducts: () => void }) {
  ...
  return (
    <section className="bg-gradient-to-b from-[#f9fafb] to-white py-12 lg:py-20 px-4 lg:px-20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10 lg:mb-12">
          <h2 className="font-['Merriweather',serif] text-[#1a1a1a] mb-4 text-[2rem]">Découvrez nos produits</h2>
          <p className="text-[#4a5565] max-w-2xl mx-auto">
...
function Categories() {
  ...
  return (
    <section className="bg-white py-12 lg:py-20 px-4 lg:px-20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10 lg:mb-12">
          <h2 className="font-['Merriweather',serif] text-[#1a1a1a] mb-4 text-[2rem]">Catégories de produits</h2>
          <p className="text-[#4a5565] max-w-2xl mx-auto">
  ...
  return (
    <section className="bg-gray-50 py-12 lg:py-20 px-4 lg:px-20">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6">
            <h2 className="font-['Merriweather',serif] text-[#1a1a1a]">
  ...
  return (
    <section className="bg-white py-12 lg:py-20 px-4 lg:px-20">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10 lg:mb-12">
          <h2 className="font-['Merriweather',serif] text-[#1a1a1a] mb-4 text-[2rem]">Questions fréquentes</h2>
  ...
  return (
    <section className="bg-[#2b2d31] py-16 lg:py-24 px-4 lg:px-20">
      <div className="max-w-4xl mx-auto text-center space-y-6">
        <h2 className="font-['Merriweather',serif] text-white text-[2rem]">
