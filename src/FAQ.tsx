    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gray-50 py-12 lg:py-20 px-4 lg:px-20 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-['Merriweather',serif] text-[#1a1a1a] mb-4 text-[3rem]">Questions Fréquentes</h1>
      ...
      <section className="py-12 lg:py-16 px-4 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-['Merriweather',serif] text-[#0d1421] mb-8">
            {categoryTitle}
          </h2>
      ...
      <section className="py-12 lg:py-16 px-4 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#2c3340] rounded-3xl p-8 lg:p-12 text-center">
            <h2 className="font-['Merriweather',serif] text-white mb-3">
